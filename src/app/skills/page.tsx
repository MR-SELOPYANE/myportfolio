export default function ServicesPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      ...
      <div className="flex flex-nowrap space-x-6 overflow-x-auto py-4 scrollbar-thin scrollbar-thumb-cosmic-blue/50 scrollbar-track-space-800">
        {services.map((service, idx) => (
          <div
            key={idx}
            className="w-[320px] flex-shrink-0 glass-panel p-6 rounded-2xl
          ...
          >
            {/* Icon */}
            <div className="w-14 h-14 bg-space-700/80 rounded-full flex items-center justify-center mb-4">
              <svg
            ...
            {/* Title */}
            <h2 className="text-2xl font-bold text-neon-blue mb-2 truncate">
              {service.title}
            </h2>

            {/* Description */}
            <p className="text-stars-200 text-sm leading-relaxed break-words">
              {service.description}
            </p>
          </div>
        ))}
